          ...
          <div className="glass-panel neon-border rounded-xl p-4 flex flex-col gap-3 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-2 font-mono text-[11px] text-gray-300">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-white truncate ml-2">Qadri AI OS v1.0.31</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            <div className="flex flex-wrap gap-2">
              {TOOLS.map(tool => {
                ...
                return (
                  <motion.div 
                    key={tool.id}
                    className={`flex items-center gap-2 px-2 py-1.5 rounded-md text-[10px] font-mono transition-all duration-300
                      ${isActive 
                        ? 'bg-gradient-to-br from-secondary/30 to-primary/30 border-t border-l border-white/20 border-r border-b border-black/50 text-secondary shadow-[3px_3px_6px_rgba(0,0,0,0.6),-2px_-2px_4px_rgba(255,255,255,0.05),inset_1px_1px_2px_rgba(255,255,255,0.1)]' 
                        : 'bg-gray-900/50 border-t border-l border-white/5 border-r border-b border-black/80 text-gray-500 shadow-[2px_2px_4px_rgba(0,0,0,0.5),inset_1px_1px_2px_rgba(255,255,255,0.02)]'}`}
